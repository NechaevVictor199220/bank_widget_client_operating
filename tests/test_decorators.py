...
class TestLogDecorator:
    ...
    def test_log_to_console_with_args_kwargs(self, capsys):
    ...
    def test_log_to_console_error_with_args(self, capsys):
    ...
    def test_multiple_functions_same_log_file(self):
